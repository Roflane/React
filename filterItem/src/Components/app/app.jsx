...
export default class App extends Component {
    ...
    state = {
        todos:[
            ...
            {label: "Но без корбки передач.", important: false, id:4, done: true},
        ],
        filter: 'all',
        search:''
    }
    ...
    render() {
        ...
        const searchedItems = this.searchItems(todos, search);
        const visibleItems = this.filterItems(searchedItems, filter);
